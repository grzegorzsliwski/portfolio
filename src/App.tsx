...
function AppContent() {
  ...
  return (
    <CursorOverlay>
      ...
      {started && (
        <div
          className="flex flex-col items-center bg-[#0a0a0a]"
        ...
        >
          ...
          <section
            id="about"
            className="relative w-full pt-32 overflow-x-hidden"
          >
                  ...
                  <div>
                    ...
                    <TextReveal
                      ...
                      highlights={Object.fromEntries(
                        t.scrollReveal1Highlight.map((word) => [
                          word,
                          "rgba(74,222,128,1)",
                        ]),
                      )}
          ...
          <section className="relative w-full py-16 mb-8 md:py-32 md:mb-16">
            <div className="max-w-[80rem] mx-auto px-6 md:px-24">
              ...
              <TextReveal
                ...
                scrollColor={scrollColor}
                highlights={Object.fromEntries(
                  t.projectText1Highlight.map((word) => [
                    word,
                    "rgba(74,222,128,1)",
                  ]),
                )}
